...
public class AdminLoginPage {
	...
	public static boolean isUnsuccessfulLogin() {
		WebElement validationMessage = Browser.instance.findElement(By.className("warning"));
		return validationMessage.getText().trim().equalsIgnoreCase("No match for Username and/or Password.");
	}
